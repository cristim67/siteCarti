  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Metode cantitative în eMarketing 
    ...
    <section class="product-sec">
        <div class="container">
            <h1>Metode cantitative în eMarketing 
            ...
            <div class="row">
                    ...
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r30.jpg" class="img-fluid" style="width: 1000px; height:500px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r30.jpg" class="img-fluid">
                            </a>
                            </li>
                ...
                <div class="col-md-6 slider-content">
                    <p>De  ce  nu  am  încerca  să  reînvăţăm  ceva  din  vechile  poveşti? se întreabăE.I.M. Să ne clarificăm înţelesurile lumii de azi ajutaţi de întâmplări  închipuite,  cu  personaje  închipuite,  dar  cu  tâlc  atât  de  adânc. Să facem un lucru serios pornind de la o joacă. Iar povestea propusă este „Cei trei purceluşi“. 
</p>
                    <ul>
                        <li>
                    ...
                    <div class="btn-sec">
                        <a href="https://drive.google.com/file/d/1XN-BY88_f0xK70ep_USTVNmgvQ7CgpmK/view?usp=sharing"><button class="btn ">Citeste acum</button></a>
                    </div>
                </div>
            </div>
        </div>
