  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Marketingul intreprinderilor mici si mijlocii Marketingul intreprinderilor mici si mijlocii 
    ...
    <section class="product-sec">
        <div class="container">
            <h1>Marketingul intreprinderilor mici si mijlocii 
            ...
            <div class="row">
                    ...
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r29.jpg" class="img-fluid" style="width: 1000px; height:500px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r29.jpg" class="img-fluid">
                            </a>
                            </li>
                ...
                <div class="col-md-6 slider-content">
                    <p>Pentru a putea analiza problemele legate de întreprinderile mici şi mijlocii, este mai întâi  necesară  definirea  acestora.  Pentru  a  putea  clasifica  întreprinderile  existente  pe  o  anumită  piaţă  este  necesară,  în  primul  rând,  alegerea  unor  reguli  după  care  trebuiesc  identificaţi indicatori care să permită o anumită structurare.  
</p>
                    <ul>
                        <li>
                    ...
                    <div class="btn-sec">
                        <a href="https://drive.google.com/file/d/1MEdmRlHWugMHb_ywDjG7mLJwPrcVcKLf/view?usp=sharing"><button class="btn ">Citeste acum</button></a>
                    </div>
                </div>
            </div>
        </div>
