  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Curs Audit Intern ASE 
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r28.jpg" class="img-fluid" style="width: 1000px; height:500px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r28.jpg" class="img-fluid">
                            </a>
                            </li>
                ...
                <div class="col-md-6 slider-content">
                    <p>Prin audit se înţelege:a)examinarea/cercetarea,  profesionistă  şi  obiectivă,  de  către  o  persoană  competentă  şi independentă, a unei informaţii, activităţi sau operaţiuni, a probităţii şi credibilităţii tranzacţiilor economice, precum şi a reprezentărilor financiareşi contabile, cu scopul de a:aprecia fiabilitatea ori eficienţa sistemelor şi procedurilor unei entităţi economice;produce o judecată motivată şi independentă, cu referinţă la normele de evaluare;obţineo concluzie şi o opinie rezonabilă şi independentă, prin raportarea la un criteriu sau standard;b)procesul desfăşurat de auditori –persoane fizice sau juridice legal autorizate -prin care se analizează  şi  evaluează,  profesionist,  informaţii  privind  o  entitate,  prin  tehnici  şi  procedee specifice, în vederea obţinerii de dovezi numite probe de audit.
</p>
                    <ul>
                        <li>
                    ...
                    <div class="btn-sec">
                        <a href="https://drive.google.com/file/d/1lxaLstmKq7tcws8AQLlgyhq3HwOpL1Oy/view?usp=sharing"><button class="btn ">Citeste acum</button></a>
                    </div>
                </div>
            </div>
        </div>
