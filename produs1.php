  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Tatuatorul de la Auschwitz</span>
        </div>
    </div>
    <section class="product-sec">
        <div class="container">
            <h1>Tatuatorul de la Auschwitz</h1>
            <div class="row">
                <div class="col-md-6 slider-sec">
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/img1.jpg" class="img-fluid" style="width: 1000px;">
                            </div>
