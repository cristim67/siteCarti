  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Management 
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r27.jpg" class="img-fluid" style="width: 1000px; height:500px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r27.jpg" class="img-fluid">
                            </a>
                            </li>
                ...
                <div class="col-md-6 slider-content">
                    <p>1.1  Ce este managementul si ce fac managerii? Considerăm  necesar  să  începem  această  lucrare  prin  explicarea  semnificatiei pe care o are, uzual, termenul management atât în lucrările de specialitate cât ii în practica úi vorbirea curentă.Managementul are o triplă semnificatie: activitate practică (proces), factor de decizie (echipă sau individ)stiintifica.Managementul  ca  proces  este  un  tip  special  de  muncă  intelectuală,prin care cei ce o practică îi determină pe altii să facă ceva ce trebuie făcut. Prin  management  se  întelege  uzual  ii  un  grup,  o  echipă  sau  o  persoană  investiti  cu  autoritatea,  competentele úi  răspunderile  functiei  de  conducere într-o organizatie. 
</p>
                    <ul>
                        <li>
                    ...
                    <div class="btn-sec">
                        <a href="https://drive.google.com/file/d/1Y0nhWx1iKGOhFiPFYSUYPGhN1thT93um/view?usp=sharing"><button class="btn ">Citeste acum</button></a>
                    </div>
                </div>
            </div>
        </div>
