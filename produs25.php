  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Curs de pneumologie pentru studenti</span>
        </div>
    </div>
    <section class="product-sec">
        <div class="container">
            <h1>Curs de pneumologie pentru studenti</h1>
            <div class="row">
                <div class="col-md-6 slider-sec">
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r21.jpg" class="img-fluid" style="width: 1000px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r21.jpg" class="img-fluid">
                            </a>
                            </li>
                            </a>
                            </li>
                ...
                <div class="col-md-6 slider-content">
                    <p>Un istoric atent și complet, respectiv efectuarea unui examen clinic minuțios sunt atuurile
...
informațiilor anamnestice, pe măsură ce acestea devin disponibile
                    ...
                    <div class="btn-sec">
                        <a href="https://drive.google.com/file/d/1QR8lfNPaMPj8tcR6rV80uiBrxmBf4hQ5/view?usp=sharing"><button class="btn ">Citeste acum</button></a>
                    </div>
                </div>
            </div>
        </div>
