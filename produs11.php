  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Cel mai iubit dintre pământeni</span>
        </div>
    </div>
    <section class="product-sec">
        <div class="container">
            <h1>Cel mai iubit dintre pământeni</h1>
            <div class="row">
                <div class="col-md-6 slider-sec">
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r7.jpg" class="img-fluid" style="width: 1000px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r7.jpg" class="img-fluid">
                            </a>
                            </li>
                            </a>
                            </li>
                ...
                <div class="col-md-6 slider-content">
                    <p>Omanul Cel mai iubit dintre pamanteni, 1980 (trei volume, insumand peste 1200 de pagini) este prezentat cititorilor ca un text memorialistic si justificativ scris in inchisoare de un barbat cultivat (candva asistent la o catedra de filosofia culturii), Victor Petrini, acuzat de crima. El urmeaza sa apara in scurt timp in fata unei instante judecatoresti care l-ar putea condamna la inchisoare pe viata si incearca – sfatuit de avocat – sa-l castige pe judecator de partea sa, prin sinceritate, pentru a obtine o reducere a pedepsei.Se poate spune, asadar, ca romanul are factura unei marturisiri complete. Dar el este, in acelasi timp, si un raport catre Dumnezeu (de genul celui imaginat de Kazantzakis),
intrucat Victor Petrini, sceptic in ceea ce priveste norocul sau in viata, se adreseaza, prin ceea ce scrie, nu numai instantei judecatoresti, ci si uneia mai inalte, care poate fi posteritatea sau Dumnezeu insusi.
</p>
                    <ul>
                        <li>
                    ...
                    <div class="btn-sec">
                        <a href="https://drive.google.com/file/d/15FzJntr5p-5zRwulxOQLqDJ9vuAdygvM/view?usp=sharing"><button class="btn ">Citeste acum</button></a>
                    </div>
                </div>
            </div>
        </div>
