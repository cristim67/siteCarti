  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Cuvinte despre lumină (vol. 2). Poarta jurământului</span>
        </div>
    </div>
    <section class="product-sec">
        <div class="container">
            <h1>Cuvinte despre lumină (vol. 2). Poarta jurământului</h1>
            <div class="row">
                <div class="col-md-6 slider-sec">
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r14.jpg" class="img-fluid" style="width: 1000px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r14.jpg" class="img-fluid">
                            </a>
                            </li>
                            </a>
                            </li>
                ...
                <div class="col-md-6 slider-content">
                    <p>Câmpiile Sfărâmate cunosc încă o bătălie, posibil confruntarea finală. Cu riscul unui nou legământ cu Pustiitorii, parshendii sunt hotărâți să-și învingă vechii dușmani. Descoperirea lui Shallan i-ar putea salva pe toți, însă eforturile ei par sortite eșecului. 
