  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Strainul de langa mine</span>
        </div>
    </div>
    <section class="product-sec">
        <div class="container">
            <h1>Strainul de langa mine</h1>
            <div class="row">
                <div class="col-md-6 slider-sec">
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r9.jpg" class="img-fluid" style="width: 1000px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r9.jpg" class="img-fluid">
                            </a>
                            </li>
                            </a>
                            </li>
                ...
                <div class="col-md-6 slider-content">
                    <p>Strainul de langa mine este noua carte semnata de autoarea bestsellerelor "Fluturi" si "Insomnii", Irina Binder.
...
Cine esti Tu? Cine este Celalalt?
                    ...
                    <ul>
                        <li>
                            ...
                            <span class="price final">20lei</span>
                    </ul>
                    <div class="btn-sec">
