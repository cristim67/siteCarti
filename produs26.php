  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">CURS DE ECOGRAFIE ABDOMINALĂ PENTRU STUDENŢI
    ...
    <section class="product-sec">
        <div class="container">
            <h1>CURS DE ECOGRAFIE ABDOMINALĂ PENTRU STUDENŢI
            ...
            <div class="row">
                    ...
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r23.jpg" class="img-fluid" style="width: 1000px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r23.jpg" class="img-fluid">
                            </a>
                            </li>
                            </a>
                            </li>
                ...
                <div class="col-md-6 slider-content">
                    <p>Ecografia abdominală este una din cele mai accesibile metode imagistice folosite în
practica de zi cu zi. În medicina modernă trebuie considerată o prelungire a examenului clinic,
fiind de un real folos atât în urgență, cât și pentru evaluarea inițială și urmărirea pacienților cu
diferite simptome abdominale, cu hepatopatii cronice, a pacienților oncologici, a celor cu
traume abdominale ușoare etc.
                    ...
                    <div class="btn-sec">
                        <a href="https://drive.google.com/file/d/1XRaj9T0S4e4m3-zq7EYpSliwd6FHtRE0/view?usp=sharing"><button class="btn ">Citeste acum</button></a>
                    </div>
                </div>
            </div>
        </div>
