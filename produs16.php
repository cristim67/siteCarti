  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Un baiat pe lista lui Schindler</span>
        </div>
    </div>
    <section class="product-sec">
        <div class="container">
            <h1>Un baiat pe lista lui Schindler</h1>
            <div class="row">
                <div class="col-md-6 slider-sec">
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r12.jpg" class="img-fluid" style="width: 1000px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r12.jpg" class="img-fluid">
                            </a>
                            </li>
                            </a>
                            </li>
