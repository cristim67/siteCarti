  ...
  display: flex;">
    ...
    <div class="breadcrumb">
        <div class="container">
            ...
            <span class="breadcrumb-item active">Medicina psihiatrică la cumpăna dintre milenii
    ...
    <section class="product-sec">
        <div class="container">
            <h1>Medicina psihiatrică la cumpăna dintre milenii
                    ...
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="images/r24.jpg" class="img-fluid" style="width: 1000px;">
                            </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                ...
                                <img src="images/r24.jpg" class="img-fluid">
                            </a>
                            </li>
                            </a>
                            </li>
...
care în perioada hipocraticogalenică era descrisă atât ca
temperament, cât şi ca maladie;
şi explicată prin dezechilibrul
dintre umori, cu predominarea
bilei negre (melonas colé).
Totuşi, în perioada iluminismului, impunerea raţiunii a făcut ca aceşti oameni
...
XIX-lea, când psihiatria şi-a ocupat oficial locul printre clinicile medicale. Bolnavi
psihici au rămas izolaţi în azilele de neuropsihiatrie, plasate în afara oraşelor
                    ...
                    <div class="btn-sec">
                        <a href="https://drive.google.com/file/d/1W9WbIOymUZFt6zF5BA-EQX0kFOb6nMhC/view?usp=sharing"><button class="btn ">Citeste acum</button></a>
                    </div>
                </div>
            </div>
        </div>
